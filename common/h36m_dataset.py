...
class Human36mDataset(MocapDataset):
    ...
    def __init__(self, path, remove_static_joints=True):
        ...
        # 相机参数操作
        self._cameras = copy.deepcopy(h36m_cameras_extrinsic_params) # 深拷贝
        for cameras in self._cameras.values():# 整合内外参数
        ...
        self._data = {}
        for subject, actions in data.items(): # 主体和动作存储字典
            self._data[subject] = {}
