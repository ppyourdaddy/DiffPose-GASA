...
class GraphNet2(nn.Module):
    ...
    def __init__(self, adj, in_features=2, out_features=2, n_pts=21):
        ...
        # 改
        self.gat1 = GAT(input_size=in_features ,
                        hidden_size=in_features /8,
                        output_size=out_features,dropout=0.6,nheads=8,alpha=0.2)

    def forward(self, X):
        X_0 = self.gconv1(X, self.A_hat)
        X_1 = self.gconv2(X_0, self.A_hat)
        X_2 = self.gat1(X_1, self.adj)
        return X_2
